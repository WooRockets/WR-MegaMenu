...
( function ($)
{
    $.WRPopoverOptions	= $.WRPopoverOptions || {};

    $.WRPopoverOptions = function () {};

    $.WRPopoverOptions.prototype = {
        init:function(){
            ...
            if (typeof dialog_html == 'object') {
                ...
                dialog = $("<div/>", {
                    ...
                    $("<div/>", {
                        ...
                        $("<h3/>", {
                            "class":"popover-title",
                            text: options.el_title + ' ' + Wr_Megamenu_Translate.settings
                        })
                    ).append(
                        $("<div/>", {
    ...
    $(document).ready(function(){
        var Wr_Content = new $.WRPopoverOptions();
        Wr_Content.init();
    })
